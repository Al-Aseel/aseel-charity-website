                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4 rtl:space-x-reverse">
                          ...
                          <div>
                            <h3 className="font-semibold text-lg mb-2">{info.title[language]}</h3>
                            <p className="text-muted-foreground whitespace-pre-line">{info.content[language]}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <CardContent className="p-0">
                    <div className="aspect-video bg-gray-200 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">{language === "ar" ? "خريطة الموقع" : "Location Map"}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
