...
const categories = [
  ...
  { id: "empowerment", name: { ar: "تمكين اقتصادي", en: "Economic Empowerment" } },
]
                  ...
                  <Card className="h-full hover:shadow-lg transition-shadow">
                    <div className="aspect-video relative overflow-hidden rounded-t-lg">
                      ...
                      <div className="absolute top-4 left-4 rtl:right-4 rtl:left-auto">
                        <Badge className={getCategoryColor(item.category[language])}>{item.category[language]}</Badge>
                      </div>
                    </div>
                    <CardHeader>
                      ...
                      <h3 className="font-semibold text-lg leading-tight">{item.title[language]}</h3>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground mb-4 line-clamp-3">{item.excerpt[language]}</p>
                      <Button
                        variant="ghost"
